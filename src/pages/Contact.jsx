          ...
          <aside className="contact-sidebar">
            ...
            <div className="contact-social-card">
              ...
              <div className="contact-social-links">
                <a
                  href="https://www.instagram.com/aetech.dev/"
                ...
                <a
                  href="https://www.linkedin.com/in/abayomi-eniola-013a74343/"
                  className="contact-social-link"
                  aria-label="LinkedIn"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.tiktok.com/@a_e.tech"
                  className="contact-social-link"
                  aria-label="TikTok"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <path d="M14 3c1 2 2.5 3.5 4.5 4" />
                    <path d="M14 7a6.5 6.5 0 0 0 4.5 1.5" />
                  </svg>
                </a>
              </div>
            </div>
